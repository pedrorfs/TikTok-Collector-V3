...
with sync_playwright() as pw:
    ...
    page.goto("https://www.tiktok.com/@enaldinho")

    # Wait for the page to load initially
    page.wait_for_load_state("networkidle")

    # Scroll and capture responses multiple times
    for _ in range(10):  # Scroll 5 times as an example
        scroll_page(page)
    
    # Wait for responses to be captured
    page.wait_for_timeout(3000)  # Wait 2 seconds to capture all responses

    # Optionally, save the captured responses to a file
